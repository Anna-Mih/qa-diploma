...
**12. Отправка формы с несуществующим месяцем в поле "Месяц":**
>1. Заполнить поле "Номер карты": 4444 4444 4444 4441
>1. Ввести "13" в поле "Месяц"
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "Владелец" валидными данными
>1. Заполнить поле "cvc/cvv" валидными данными
>1. Нажать кнопку "Продолжить"  
...
**13. Отправка формы с введенными нулями в поле "Год":**
>1. Заполнить поле "Номер карты": 4444 4444 4444 4441
>1. Заполнить поле "Месяц" валидными данными
...
**14. Отправка формы с введенными нулями в поле "cvc/cvv":**
>1. Заполнить поле "Номер карты": 4444 4444 4444 4441
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "Владелец" валидными данными
...
**15. Отправка формы с частично заполненным номером карты:**
...
**16. Отправка формы с истекшим сроком действия карты:**
>1. Заполнить поле "Номер карты" : 4444 4444 4444 4441
...
**17. Ввести валидные данные во все поля формы:**
...
**18. В поле "Владелец" ввести данные через дефис:**
>1. Ввести в поле "Номер карты" валидные данные: 4444 4444 4444 4441
>1. Ввести в поля "Месяц", "Год", "cvc/cvv" валидные данные
>1. Ввести в поле "Владелец" данные через дефис (Например: Sokolov-Mikitov)
>1. Нажать кнопку "Продолжить"  
...
**19. Отправить пустую форму:**
>1. Нажать кнопку "Продолжить"  
*Ожидаемый результат:* форма не отправляется, выдаются соответствующие сообщения

**20. Отправить форму c незаполненным полем "Номер карты":**
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "Владелец" валидными данными
>1. Заполнить поле "cvc/cvv" валидными данными
...
**21. Отправить форму c незаполненным полем "Месяц":**
>1. Заполнить поле "Номер карты": 4444 4444 4444 4441
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "Владелец" валидными данными
>1. Заполнить поле "cvc/cvv" валидными данными
...
**22. Отправить форму c незаполненным полем "Год":**
>1. Заполнить поле "Номер карты" : 4444 4444 4444 4441
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Владелец" валидными данными
>1. Заполнить поле "cvc/cvv" валидными данными
...
**23. Отправить форму c незаполненным полем "Владелец":**
>1. Заполнить поле "Номер карты": 4444 4444 4444 4441
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "cvc/cvv" валидными данными
...
**24. Отправить форму c незаполненным полем "CVC/CVV":**
>1. Заполнить поле "Номер карты" : 4444 4444 4444 4441
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "Владелец" валидными данными
...
**25. Отправить форму с введенным номером заблокированной карты:**
...
**26. Отправка формы с введенными данными на кириллице в поле "Владелец":**
>1. Заполнить поле "Номер карты" : 4444 4444 4444 4441
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Год" валидными данными
...
**27. Отправка формы с частично заполненным номером карты:**
>1. Заполнить поле "Номер карты" : 4444 4444 4444 444
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "Владелец" валидными данными
...
**28. Отправка формы с истекшим сроком действия карты:**
>1. Заполнить поле "Номер карты" : 4444 4444 4444 4441
>1. Заполнить поле "Месяц" данными прошлого месяца
>1. Заполнить поле "Год" значением текущего года
>1. Заполнить поле "Владелец" валидными данными
...
**29. Отправка формы с несуществующим месяцем в поле "Месяц":**
>1. Заполнить поле "Номер карты": 4444 4444 4444 4441
>1. Ввести "13" в поле "Месяц"
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "Владелец" валидными данными
...
**30. Отправка формы с введенными нулями в поле "Номер карты":**
>1. Заполнить поле "Номер карты" нулями: 0000 0000 0000 0000
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "Владелец" валидными данными
...
**31. Отправка формы с введенными нулями в поле "Месяц":**
>1. Заполнить поле "Номер карты": 4444 4444 4444 4441
>1. Ввести нули в поле "Месяц"
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "Владелец" валидными данными
...
**32. Отправка формы с введенными нулями в поле "Год":**
>1. Заполнить поле "Номер карты": 4444 4444 4444 4441
>1. Заполнить поле "Месяц" валидными данными
>1. Ввести нули поле "Год" 
>1. Заполнить поле "Владелец" валидными данными
...
**33. Отправка формы с введенными нулями в поле "cvc/cvv":**
>1. Заполнить поле "Номер карты": 4444 4444 4444 4441
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "Владелец" валидными данными
...
# План сдачи работы
1. Написание автотестов : 10.10.2022
1. Предоставление отчетов : 12.10.2022
