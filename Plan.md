...
**3. В поле "Владелец" ввести данные через дефис:**
>1. Ввести в поле "Номер карты" валидные данные
...
**8. Отправить форму c незаполненным полем "Месяц":**
...
**9. Отправить форму c незаполненным полем "Год":**
>1. Заполнить поле "Номер карты" : 4444 4444 4444 4441
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Владелец" валидными данными
>1. Заполнить поле "cvc/cvv" валидными данными
...
**10. Отправить форму c незаполненным полем "Владелец":**
>1. Заполнить поле "Номер карты": 4444 4444 4444 4441
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "cvc/cvv" валидными данными
...
**11. Отправить форму c незаполненным полем "CVC/CVV":**
>1. Заполнить поле "Номер карты" : 4444 4444 4444 4441
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Год" валидными данными
>1. Заполнить поле "Владелец" валидными данными
...
**17. Отправить форму с введенным номером заблокированной карты:**
...
**19. Отправка формы с введенными данными на кириллице в поле "Владелец":**
>1. Заполнить поле "Номер карты" : 4444 4444 4444 4441
>1. Заполнить поле "Месяц" валидными данными
>1. Заполнить поле "Год" валидными данными
...
**21. Отправка формы с частично заполненным номером карты:**
...
**23. Отправка формы с истекшим сроком действия карты:**
>1. Заполнить поле "Номер карты" : 4444 4444 4444 4441
